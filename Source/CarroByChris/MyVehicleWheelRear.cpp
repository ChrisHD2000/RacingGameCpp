...
UMyVehicleWheelRear::UMyVehicleWheelRear() {
	...
	// Define el radio de los neumáticos traseros
	ShapeRadius = 22.97f ;
	// Define el espesor de los neumáticos traseros
	ShapeWidth = 20.07f ;
	// Define si los neumáticos traseros se ven afectados por el freno de mano o no
	bAffectedByHandbrake = true;
	// Define el ángulo de giro máximo de los neumáticos traseros
	SteerAngle = 0.f;
